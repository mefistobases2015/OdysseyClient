...
SELECT P.usr_name, V.id3v2_title, V.id3v2_author, V.id3v2_album, V.id3v2_year, V.id3v2_genre, 
V.id3v2_lyrics, V.submission_date, C.song_directory, C.local_song_id, C.cloud_song_id
